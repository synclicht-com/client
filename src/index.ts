...
class ProjectionStore {
    ...
    private projectionUpdateSubscriptions: Map<string, Set<(projectionContent: any) => void>> | undefined
            ...
            switch (msg.subject) {
                ...
                case 'ServerReady':
                    ...
                    try {
                        ...
                        await this.storage.iterate(function (value: any, key: string) {
    ...
    unsubscribeToProjectionUpdate(projection: string, listener: (projectionContent: any) => {}) {
        try {
